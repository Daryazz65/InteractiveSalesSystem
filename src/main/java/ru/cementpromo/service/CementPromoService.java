...
public class CementPromoService {
    ...
    public Map<String, BigDecimal> calculate(
        ...
        return IntStream.range(0, sortedOrders.size())
                .mapToObj(i -> {
                    ...
                    BigDecimal currentDiscount = getDiscountByIndex(i, startDiscount, discountStep);
                    BigDecimal finalCost = calculateCost(order.kg(), currentDiscount, pricePerKg);
    ...
    private BigDecimal getDiscountByIndex(int index, BigDecimal startDiscount, BigDecimal discountStep) {
    ...
    private BigDecimal calculateCost(int kg, BigDecimal discount, BigDecimal pricePerKg) {
